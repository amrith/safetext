...
#ifndef __ST_CODEBOOK_H_DEFINED__
#define __ST_CODEBOOK_H_DEFINED__
...
typedef struct
{
    ...
    unsigned char reverse[CHARSET_LENGTH];
} codebook_t;

extern int __charix(char c);
extern codebook_t codebook[];
